...
const PLUGIN_CATALOG: CatalogEntry[] = [
  ...
  { id: 'wecom', spec: '@openclaw-china/wecom', name: 'WeCom', nameZh: '企业微信', description: 'WeCom (WeChat Work) messaging channel plugin', descriptionZh: '企业微信消息渠道插件', icon: '💼', category: 'channel', relatedChannels: ['wecom'] },
